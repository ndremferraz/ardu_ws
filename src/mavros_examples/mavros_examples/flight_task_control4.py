...
def main(args=None):
    ...
    try:
        ...
        for i in range(4):
            yaw = math.radians(90 * i)  # Rotate 90 degrees at each waypoint
            task_control.get_logger().info('Rotating 90 degrees...')
            task_control.goto_xyz_rpy(0.0, 0.0, altitude, 0.0, 0.0, yaw)
            time.sleep(5)
