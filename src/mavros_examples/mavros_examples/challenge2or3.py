...
class TaskControl(Node):
    ...
    def waypoints_to_pad(self, step_size=1.0):
    ...
    def ready_to_land(self, xy_tolerance=0.15, z_tolerance=0.15):
...
def main(args=None):
    ...
    try:
        ...
        if not task_control.takeoff(height):
        ...
        for (x, y, z) in new_waypoints:
            ...
            task_control.goto_pose(x,y,height,0.0)
