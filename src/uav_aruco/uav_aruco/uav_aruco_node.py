...
BOTTOM_CAMERA_MATRIX = np.array([
    [376.46513847, 0.0, 319.09623696],
    [0.0, 376.24453493, 219.88931289],
    [0.0, 0.0, 1.0]
], dtype=np.float64)
...
class ArUcoDetector(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('uav_loc_topic', '/zed/zed_node/pose')

        self.declare_parameter('bottom_img_topic','/img_raw')
        ...
        self.bottom_target_pub = self.create_publisher(PoseStamped, "/target_aruco_pose", 3)
        self.bottom_pad_pub = self.create_publisher(PoseStamped, "/pad_aruco_pose", 3)
